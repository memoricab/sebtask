package com.seb.lithuaniaservice;
...
@SpringBootTest(classes = LithuaniaserviceApplication.class)
...
public class TranslationControllerIntegrationTest extends AbstractTest {
    ...
    public void checkApiReturnsHelloTranslationAndSuccessAndServiceHeader_WhenPathIsValid() throws Exception {
        ...
        TranslationPojo lithuanianTranslation = objectMapper.readValue(response.getContentAsString(), TranslationPojo.class);

        Assert.assertEquals(200, response.getStatus());
        Assert.assertEquals("lithuania", response.getHeaderValue("translation-service"));
        assertThat(lithuanianTranslation.getTranslation()).isEqualTo("Labas");
    }
}
