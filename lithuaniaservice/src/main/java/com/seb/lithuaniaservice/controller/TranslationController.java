package com.seb.lithuaniaservice.controller;

import com.seb.lithuaniaservice.service.LithuanianTranslation;
...
public class TranslationController implements ErrorController {
    ...
    private static final String SERVICE_HEADER_VALUE = "lithuania";
    ...
    public TranslationPojo translateWord(HttpServletRequest request, HttpServletResponse response, @PathVariable(name = "word") String word) {
        ...
        response.addHeader(SERVICE_HEADER, SERVICE_HEADER_VALUE); // Adding this header in order to identify service in pelican app.
        return LithuanianTranslation.getTranslation();
