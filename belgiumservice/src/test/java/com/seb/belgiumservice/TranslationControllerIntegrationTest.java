package com.seb.belgiumservice;
...
@SpringBootTest(classes = BelgiumserviceApplication.class)
...
public class TranslationControllerIntegrationTest extends AbstractTest {
    ...
    public void checkApiReturnsHelloTranslationAndSuccessAndServiceHeader_WhenPathIsValid() throws Exception {
        ...
        TranslationPojo frenchTranslation = objectMapper.readValue(response.getContentAsString(), TranslationPojo.class);

        Assert.assertEquals(200, response.getStatus());
        Assert.assertEquals("belgium", response.getHeaderValue("translation-service"));
        assertThat(frenchTranslation.getTranslation()).isEqualTo("Bonjour");
    }
